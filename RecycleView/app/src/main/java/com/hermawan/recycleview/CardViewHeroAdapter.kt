...
class CardViewHeroAdapter(private val listHero: ArrayList<Hero>) : RecyclerView.Adapter<CardViewHeroAdapter.CardViewViewHolder>() {
    class CardViewViewHolder(itemView: View):RecyclerView.ViewHolder(itemView) {
        var imgPhoto: ImageView = itemView.findViewById(R.id.imgHero)
        var tvName: TextView = itemView.findViewById(R.id.textName)
        var tvDetail: TextView = itemView.findViewById(R.id.textDetail)
        var btnFavorite: Button = itemView.findViewById(R.id.btnSetFav)
